...
| iOS background central/peripheral modes | Capacitor shell plus `UIBackgroundModes` | Configured; physical build/run pending |
...
| Incoming alert, notification, haptic, and local history | Mesh event path and Capacitor plugins | Built; hardware receipt pending |
...
| Deterministic drills with congestion and battery constraints | Jac drill domain and Command view | Built; Jac tests pass |
...
- Two physical devices for Android-to-iOS and iOS-to-Android BLE, foreground
  and background.
- Full Xcode build, signing, launch, and background wake on iOS.
